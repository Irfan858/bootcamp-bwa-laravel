    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
                ...
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('backsite.dashboard.index') }}">Home</a></li>
                                <li class="breadcrumb-item"><a href="{{ route('backsite.specialist.index') }}">Specialist</a></li>
            ...
            <div class="content-body">
                <section id="horizontal-forms-layouts">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal" action="{{ route("backsite.specialist.update", [$specialist->id]) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    <label for="price" class="col-md-3 label-control">Price <code style="color:red;">required</code></label>
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="price" name="price" class="form-control" placeholder="example price 10000" value="{{ old('price', isset($specialist) ? $specialist->price : '') }}" autocomplete="off" data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'autoGroup': true, 'digits': 0, 'digitsOptional': 0, 'prefix': 'IDR ', 'placeholder': '0'" required>                                                        @if ($errors->has('price'))
